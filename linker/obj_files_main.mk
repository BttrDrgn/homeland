...
SOURCES :=\
	...
	$(BUILD_DIR)/src/main/Dolphin/arith.o\
	$(BUILD_DIR)/src/main/Dolphin/buffer_io.o\
	$(BUILD_DIR)/src/main/Dolphin/critical_regions.gamecube.o\
	$(BUILD_DIR)/src/main/Dolphin/ctype.o\
	...
	$(BUILD_DIR)/asm/main/rodata_1.o\
	$(BUILD_DIR)/asm/main/data_2.o\
