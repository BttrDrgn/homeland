...
MAP_PATH = "build/homeland.final/main.map"
...
if __name__ == "__main__":
    ...
    bytesPerPoko = dol_code_size / 100
    bytesPerPart = dol_data_size / 100
    ...
    print("\nYou have {} out of 100 levels and collected {} out of 100 collectibles.".format(pokoCount, partCount))
